			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						<t:formvalid action="insuranceController/school/class/save">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                        <input id="name" name="name"  type="text" class="form-control" value="${ycSchoolEntity.name }" placeholder="例如：2101班">
