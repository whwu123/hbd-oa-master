...
<!-- 脚本部分 -->
<t:datagrid actionUrl="ycUpdateStulogController/datagrid4" tableContentId="jqGrid_wrapper" searchGroupId="searchGroupId" fit="true" caption="学生管理" name="table_list_2" pageSize="20"  sortOrder="desc" sortName="createDate" >
	...
	<t:dgCol name="state" label="状态" replace="未审核_1,已审核_2,已完成_0,已删除_-1" width="60" display="level" ></t:dgCol>
