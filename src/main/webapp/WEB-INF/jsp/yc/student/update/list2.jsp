...
<!-- 脚本部分 -->
<t:datagrid actionUrl="ycUpdateStulogController/datagrid2" tableContentId="jqGrid_wrapper"
			searchGroupId="searchGroupId" fit="true" caption="学生管理" name="table_list_2" pageSize="20"  sortOrder="desc" sortName="createDate" >
	...
	<c:if test="${isquxianAdmin=='1'}">
		<t:dgCol name="quxianDepartment" label="区县名称" width="160"  replace="${departsReplace}" ></t:dgCol>
		<t:dgCol name="studentSchool" label="学校名称" width="120" query="true"></t:dgCol>
	</c:if>
	...
	<t:dgDelOpt label="删除" url="ycUpdateStulogController/del?id={id}" operationCode="student:update:del"/>
...
<script type="text/javascript">
	function updateStuSys(id,studentName) {
		//alert(id);
		qhConfirm("修改学生《"+studentName+"》的信息到缴费系统吗?", function(index) {
			//关闭询问
			parent.layer.close(index);
			//是
			$.post("ycUpdateStulogController/updateStuToSys", {id : id}, function(data){
				if(data.success) {
