...
<script type="text/javascript">
    ...
    function arrowUp() {
        ...
        window.location.href="reportController/export2?quxianDepartment="+quxianDepartment+"&studentSchool="+studentSchool+"&studentName="+studentName+"&studentCard="+studentCard+"&studentNianji="+studentNianji+"&studentBanji="+studentBanji+"&zhifuNumber="+zhifuNumber+"&toubaorenName="+toubaorenName+"&toubaorenPhone="+toubaorenPhone+"&createDate_begin="+createDate_begin+"&createDate_end="+createDate_end;
    }
