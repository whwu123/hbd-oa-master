...
<div class="middle-box text-center loginscreen  animated fadeInDown">
        ...
        <form class="form-horizontal m-t" id="signupForm" action="webhbd/student/save2" method="post" onSubmit="return check(this);">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select class="form-control help-block m-b-none" name="areaId" id="selectQuxian" onchange="func()" disabled="true">
                        <option>请选择区县</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control help-block m-b-none" name="schoolId" id="xuexiaoList" onchange="func2()" disabled="true">
                            <option>请选择学校</option>
