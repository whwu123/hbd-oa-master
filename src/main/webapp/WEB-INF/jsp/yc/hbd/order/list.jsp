...
<body class="gray-bg">
	...
	<!-- 脚本部分 -->
	<t:datagrid actionUrl="ycOrders/datagrid" tableContentId="jqGrid_wrapper" searchGroupId="searchGroupId" fit="true" caption="订单管理" name="table_list_2" pageSize="20" sortName="createDate" sortOrder="desc">
		<t:dgCol name="studentName" label="学生名字" width="90"  query="true"></t:dgCol>
		<t:dgCol name="id" label="编号" hidden="true" key="true" width="20"></t:dgCol>
		<%--<t:dgCol name="diquId" label="地区名称" replace="${departsReplace}" query="true" common="ycLocal" queryId="diquId" valueId="diquId"></t:dgCol>--%>
