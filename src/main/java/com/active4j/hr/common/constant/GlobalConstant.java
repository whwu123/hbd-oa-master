...
public class GlobalConstant {
	 ...
	 * 怀保代保险类型常量
	 */
	public static final String hbd_baoxian_xuesheng = "学生平安保险";
	public static final String hbd_baoxian_yiwai = "交通意外、重大疾病险";
	public static final String hbd_baoxian_jianhuren = "监护人责任险";
}
